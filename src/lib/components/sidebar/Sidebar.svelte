<script lang="ts">
  ...
  let loading = false;
  let error: any = null;
  const createSublinks: SubmitFunction = () => {
    loading = true;
  ...
  const createLinks: SubmitFunction = () => {
    loading = true;
    return async ({ result }) => {
      //   await applyAction(result);
      loading = false;
        ...
        <nav class="list-nav">
          <div>
            ...
            <div>
              <label class="label">
                <span>Link</span>
                <input class="input pl-2" name="link" type="text" placeholder="/docs" />
              </label>
            </div>
            <div>
              <label class="label">
      ...
      {#each submenu ?? [] as segment, i}
        ...
        <div class="relative hidden lg:block">
          ...
          <form
            ...
            data-popup={`formAddLinks-${segment.id}`}
          >
            <nav class="list-nav">
              ...
              <ul>
                ...
                <li>
                  ...
                  <label class="label">
                    <span>Keywords</span>
                    <InputChip bind:value={list} name="keywords" placeholder="Enter any value..." />
                  </label>
                </li>
                <hr class="!my-4" />
